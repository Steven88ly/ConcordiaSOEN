        ...
        if (context.equals("network"))
          {
            ...
            // Create semaphores and initialize them to the number of packets
    ...
    public void run() {	/* Implement here the code for the run method ... */
    	...
    	while (true)
    	{
            if(getClientConnectionStatus().equals("disconnected") 
                && (getServerConnectionStatus().equals("disconnected"))) // when both the server and network is disconnected -> terminate both thread
            {
